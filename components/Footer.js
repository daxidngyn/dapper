...
function Footer() {
  return (
    <>
      <div className=" pb-8 bg-gray-300">
        <div className="mx-auto container pt-20 flex flex-col items-center justify-center">
          ...
          <div className="text-black flex flex-col md:items-center f-f-l pt-3">
            ...
            <div className="md:flex items-center mt-5 md:mt-10 text-base text-color f-f-l">
              <h2 className=" md:mr-6 pb-4 md:py-0 cursor-pointer">I</h2>
              <h2 className="cursor-pointer">AM</h2>
            </div>
            <div className="my-6 text-base text-color f-f-l">
              <ul className="md:flex items-center">
                <li className=" md:mr-6 cursor-pointer pt-4 lg:py-0">GAY</li>
                <li className=" md:mr-6 cursor-pointer pt-4 lg:py-0">F</li>
                <li className=" md:mr-6 cursor-pointer pt-4 lg:py-0">DAVE</li>
                <li className=" md:mr-6 cursor-pointer pt-4 lg:py-0">BETA</li>
                <li className=" md:mr-6 cursor-pointer pt-4 lg:py-0">LEX</li>
                <li className="cursor-pointer pt-4 lg:py-0">SPED</li>
              </ul>
            </div>
